...
<div style="height: 60px; width: 100%; background-color: #23262E; display: flex; display: -webkit-flex;">
	<div style="width: 200px; text-align: center; vertical-align: middle;">
		<a  target="_blank" style="display: block;" href="${APP_PATH}/admin/main"><img alt="图标" style="vertical-align: middle;  "
			src="${APP_PATH}/static/images/base/main_logo.png"></a>
	</div>
	
	
	<div style="flex: 1; -webkit-flex: 1; ">
		<ul class="layui-nav">
			<li class="layui-nav-item"><a href="${APP_PATH}/admin/main">刷新页面</a></li>
		</ul>
	</div>
		...
		<ul class="layui-nav">
			<li class="layui-nav-item"><a href="javascript:;"
				class="admin-header-user"> <img
					src="${APP_PATH}/static/images/base/default_head_img.jpg"
				...
				<dl class="layui-nav-child my_top_menu layui-anim layui-anim-upbit">
					<dd>
						<a href="${APP_PATH}/user/logout">注销</a>
					</dd>
				</dl></li>
		</ul>
	</div>

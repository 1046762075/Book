...
<script type="text/javascript">
	...
	function reg(){
		...
		$.post('${APP_PATH}/user/add', {num_ : reg_num_,trueName:trueName,phone:phone,sex_:sex_,type:2,password :reg_password
		}, function(result) {
			if (result.success) {
				layer.closeAll();
	...
	function login() {
		...
		$.post('${APP_PATH}/user/login', {num_ : num_,password : password
		}, function(result) {
			if (result.success) {
...
<body>
<h1 style="text-align: center;line-height: 120px">欢迎来到图书管理系统</h1>
